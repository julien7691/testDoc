...
VSLIB is a library which allows to develop complex signal processing algorithms. Typically, it is used to develop the base-band part in a communication system, between the A/D decoder / encoder and the channel decoding / encoding block. Yes
